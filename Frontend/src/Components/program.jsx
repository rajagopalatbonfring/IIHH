  ...
  return (
    <div className="h-full text-base-content font-comic">
      <main className="pt-20 min-h-screen">
        ...
        <section
          id="hero"
          className="relative h-auto min-h-[500px] md:min-h-[600px] bg-cover bg-center overflow-hidden flex items-center bg-[#223668] pt-20 pb-24"
        ...
        {/* Call to Action */}
        <section id="program-cta" className="px-24 pb-36 bg-[#f9fcfd] relative overflow-hidden">
          <div className="text-center mt-12 bg-[#036e8d] rounded-full p-8 text-white shadow-xl">
