...
const FooterGallery = () => {
  ...
  return (
    <div 
      id="footer-social" 
      className="bg-[#036e8d]/5 p-6 sm:p-6 md:p-8 lg:p-4 rounded-xl mt-2 sm:mt-6 sm:mt-0 w-fit shadow-sm transition-shadow duration-300 shadow-xl hover:shadow-sm"
    >
      <h3 className="text-lg sm:text-xl md:text-2xl font-bubblegum text-[#036e8d] mb-4 sm:mb-6 md:mb-8 text-left sm:text-center tracking-wide">
        Explore IIHH Gallery
      </h3>
      <div className="flex justify-center">
        <div className="grid grid-cols-4 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4 max-w-fit">
          ...
          <Link
            to="#"
            className="w-12 h-10 sm:w-14 sm:h-12 md:w-16 md:h-14 flex items-center justify-center rounded-lg flex-shrink-0 bg-[#036e8d]/10 transition-all duration-500 hover:bg-transparent hover:bg-[#036e8d]/20 hover:scale-105 cursor-pointer group"
