      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-8 md:px-14 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button className="bg-white text-[#036e8d] px-12 py-4 rounded-full text-xl font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              Join Our Programs
            </button>
            <button className="text-center border-2 border-white text-white hover:bg-white hover:text-[#036e8d] font-semibold py-4 px-12 rounded-full transform hover:scale-105 transition-all duration-300 text-base sm:text-lg backdrop-blur-sm">
              Newsletter Signup
            </button>
          </div>
        </div>
